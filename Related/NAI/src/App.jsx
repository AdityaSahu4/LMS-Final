...
import { LabManagementAuthProvider } from './contexts/LabManagementAuthContext'
...
const LabManagementDocumentProcessing = lazy(() => import('./pages/lab/management/DocumentProcessingDemo'))
    ...
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/lab/management" element={<LabManagementLayout />}>
          ...
          <Route path="document-processing" element={<Suspense fallback={<PageLoader />}><LabManagementDocumentProcessing /></Suspense>} />
        </Route>
