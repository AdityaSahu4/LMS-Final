...
import { ValidationAssistant } from '../../../components/aiFeatures'
...
const steps = [
  ...
  { id: 11, name: 'Manpower', icon: UserPlus },
  { id: 12, name: 'Checklist', icon: CheckCircle2 },
]

const designationLevelOptions = [
  'Select', 'Technical Manager', 'Quality Manager', 'Other', 'Technical Assistant',
  'Lab Officer', 'Sample Cell', 'QIC', 'QA Officer', 'Q.C', 'QC Testing', 'Lab Head'
]

const degreeOptions = [
  'Select', 'Intermediate', 'ITI', 'Diploma', 'Graduation in Science/Technology',
  'Post Graduation in Science/Technology', 'Post-Doctoral', 'B.Tech/B.E.',
  'Graduate (B.Com.)', 'Graduate (B.A.)', 'Graduate (B.Sc.)', 'M.Sc', 'M.A',
  'M.Comm', 'M.TECH/M.E', 'Ph.D.', 'LLB', 'M.Phil', '10th Pass', '12th Pass'
]
...
// Personnel Card Component with Multi-Step Form
function PersonnelCard({
  ...
  const [personnelStep, setPersonnelStep] = useState('basic')

  const personnelSteps = [
    { id: 'basic', name: 'Basic Details' },
    { id: 'qualification', name: 'Qualification' },
    { id: 'experience', name: 'Work Experience' },
    { id: 'training', name: 'Training Details' }
  ]

  return (
    <Card className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">Personnel {index + 1}</h3>
        <Button
          variant="outline"
          size="sm"
          onClick={onRemove}
        ...
        <div className="flex-1">
          ...
          {personnelStep === 'basic' && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-600">Fill up details of personnel in the laboratory.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      value={person.landlineCountry}
                      onChange={(e) => onUpdate('landlineCountry', e.target.value)}
                      className="w-20 px-2 py-2.5 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    >
                      <option>+91</option>
                    </select>
                    <input
                      type="text"
                      value={person.landlineNumber}
                      onChange={(e) => onUpdate('landlineNumber', e.target.value)}
                      placeholder="1234567"
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      value={person.mobileCountry}
                      onChange={(e) => onUpdate('mobileCountry', e.target.value)}
                      className="w-20 px-2 py-2.5 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    >
                      <option>+91</option>
                    </select>
                ...
                <div>
                  ...
                  >
                    {designationLevelOptions.map(opt => (
              ...
              <div className="flex justify-end">
                <Button onClick={() => setPersonnelStep('qualification')}>
                  Next
          ...
          {/* Qualification */}
          {personnelStep === 'qualification' && (
            <div className="space-y-6">
              <h4 className="font-medium text-gray-900">Qualification</h4>
              <p className="text-sm text-gray-600">Fill up the educational qualifications of the personnel in the laboratory.</p>

              {person.qualifications.length === 0 ? (
                <div className="text-center py-8 bg-gray-50 rounded-xl">
                  <p className="text-gray-500 mb-4">No qualifications added yet</p>
                  <Button onClick={onAddQualification} size="sm">
                ...
                <>
                  {person.qualifications.map((qual) => (
                    <div key={qual.id} className="p-4 bg-gray-50 rounded-xl space-y-4">
                      <div className="flex justify-between items-center">
                        <h5 className="font-medium text-gray-900">Qualification</h5>
                        <button
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <select
                            value={qual.degree}
                            onChange={(e) => onUpdateQualification(qual.id, 'degree', e.target.value)}
                            required
                            className="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                          >
                        ...
                        <Input
                          ...
                          onChange={(e) => onUpdateQualification(qual.id, 'specialization', e.target.value)}
                        ...
                        <Input
                          ...
                          onChange={(e) => onUpdateQualification(qual.id, 'institution', e.target.value)}
                        ...
                        <Input
                          label="Period End"
                          type="month"
                          value={qual.periodEnd}
                          onChange={(e) => onUpdateQualification(qual.id, 'periodEnd', e.target.value)}
                          required
                        />

                        <div className="md:col-span-2">
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                            Certificate (PDF, max 2MB)
                          </label>
                          <label className="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-primary transition-colors">
                            ...
                            <span className="text-sm text-gray-600">
                              {qual.certificate ? qual.certificate.name : 'Choose file...'}
                            </span>
                            <input
                              type="file"
                              accept=".pdf"
                              onChange={(e) => {
                                ...
                                if (file && file.size <= 2 * 1024 * 1024) {
                                  onUpdateQualification(qual.id, 'certificate', file)
                                } else {
                                  toast.error('File must be PDF and under 2MB')
                                }
                              }}
                              className="hidden"
                            />
              ...
              <div className="flex justify-between">
                <Button variant="outline" onClick={() => setPersonnelStep('basic')}>
                  Previous
                </Button>
                <Button onClick={() => setPersonnelStep('experience')}>
                  Next
                  <ChevronRight className="w-4 h-4 ml-2" />
                </Button>
              </div>
          ...
          {/* Work Experience */}
          {personnelStep === 'experience' && (
            <div className="space-y-6">
              <h4 className="font-medium text-gray-900">Work Experience</h4>
              <p className="text-sm text-gray-600">Fill up the work experience of the personnel in the laboratory.</p>

              {person.workExperience.length === 0 ? (
                <div className="text-center py-8 bg-gray-50 rounded-xl">
                  <p className="text-gray-500 mb-4">No work experience added yet</p>
                  <Button onClick={onAddWorkExperience} size="sm">
                    <Plus className="w-4 h-4 mr-2" />
                    Add Experience
                  </Button>
                </div>
                ...
                <>
                  {person.workExperience.map((exp, idx) => (
                    <div key={exp.id} className="p-4 bg-gray-50 rounded-xl space-y-4">
                      <div className="flex justify-between items-center">
                        <h5 className="font-medium text-gray-900">Experience {idx + 1}</h5>
                        <button
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Input
                          ...
                          onChange={(e) => onUpdateWorkExperience(exp.id, 'designation', e.target.value)}
                        ...
                        <Input
                          ...
                          onChange={(e) => onUpdateWorkExperience(exp.id, 'organization', e.target.value)}
                          placeholder={idx === 0 ? formData.labName : 'Enter organization'}
                          disabled={idx === 0}
                          required
                        />
                        ...
                        <div>
                          <Input
                            ...
                            onChange={(e) => onUpdateWorkExperience(exp.id, 'periodStart', e.target.value)}
                            required
                          />
                          {idx === 0 && (
                            <label className="flex items-center mt-2">
                              <input
                                ...
                                onChange={(e) => onUpdateWorkExperience(exp.id, 'currentlyWorking', e.target.checked)}
                                className="mr-2"
                              />
                              <span className="text-sm text-gray-700">Presently Working</span>
                            </label>
                          )}
                        </div>
                        ...
                        {!exp.currentlyWorking && (
                          <Input
                            ...
                            type="month"
                            value={exp.periodEnd}
                            onChange={(e) => onUpdateWorkExperience(exp.id, 'periodEnd', e.target.value)}
                          />
                        )}
                        ...
                        <div className="md:col-span-2">
                          ...
                          <textarea
                            value={exp.rolesResponsibilities}
                            onChange={(e) => onUpdateWorkExperience(exp.id, 'rolesResponsibilities', e.target.value)}
              ...
              <div className="flex justify-between">
                <Button variant="outline" onClick={() => setPersonnelStep('qualification')}>
                  Previous
                </Button>
                <Button onClick={() => setPersonnelStep('training')}>
                  Next
                  <ChevronRight className="w-4 h-4 ml-2" />
                </Button>
              </div>
          ...
          {/* Training Details */}
          {personnelStep === 'training' && (
            <div className="space-y-6">
              <h4 className="font-medium text-gray-900">Training Details</h4>
              <p className="text-sm text-gray-600">Fill up the details of training undergone by the personnel in the laboratory.</p>

              {person.trainings.length === 0 ? (
                <div className="text-center py-8 bg-gray-50 rounded-xl">
                  <p className="text-gray-500 mb-4">No training details added yet</p>
                ...
                <>
                  {person.trainings.map((training) => (
                    <div key={training.id} className="p-4 bg-gray-50 rounded-xl space-y-4">
                      <div className="flex justify-between items-center">
                        <h5 className="font-medium text-gray-900">Training</h5>
                        <button
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Input
                          label="Training Name"
                          value={training.name}
                          onChange={(e) => onUpdateTraining(training.id, 'name', e.target.value)}
                        ...
                        <Input
                          label="Period Start"
                          type="month"
                          value={training.periodStart}
                          onChange={(e) => onUpdateTraining(training.id, 'periodStart', e.target.value)}
                          required
                        />
                        ...
                        <Input
                          label="Period End"
                          type="month"
                          value={training.periodEnd}
                          onChange={(e) => onUpdateTraining(training.id, 'periodEnd', e.target.value)}
                          required
                        />
                        ...
                        <div>
                          ...
                          <label className="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-primary transition-colors">
                            <Upload className="w-5 h-5 text-gray-400 mr-2" />
                            <span className="text-sm text-gray-600">
                              {training.certificate ? training.certificate.name : 'Choose file...'}
                            </span>
                            <input
                              type="file"
                              accept=".pdf"
                              onChange={(e) => {
                                const file = e.target.files[0]
                                if (file && file.size <= 2 * 1024 * 1024) {
                                  onUpdateTraining(training.id, 'certificate', file)
                                } else {
                                  toast.error('File must be PDF and under 2MB')
                                }
                              }}
              ...
              <div className="flex justify-between">
                <Button variant="outline" onClick={() => setPersonnelStep('experience')}>
                  Previous
                </Button>
                <Button onClick={() => toast.success('Personnel details saved!')}>
...
export default function OrganizationDetails() {
  ...
  const addPersonnelQualification = (personnelId) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
  ...
  const removePersonnelQualification = (personnelId, qualId) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
          ? {
              ...p,
              qualifications: p.qualifications.filter(q => q.id !== qualId)
            }
          : p
      )
    }))
  ...
  const updatePersonnelQualification = (personnelId, qualId, field, value) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
  ...
  const addPersonnelWorkExperience = (personnelId) => {
    const person = formData.personnel.find(p => p.id === personnelId)
    const isFirstEntry = !person || person.workExperience.length === 0
          ...
          ? {
              ...
              workExperience: [
                ...p.workExperience,
                {
                  id: Date.now(),
                  designation: '',
                  organization: isFirstEntry ? formData.labName : '',
                  periodStart: '',
                  periodEnd: '',
                  currentlyWorking: isFirstEntry,
  ...
  const removePersonnelWorkExperience = (personnelId, expId) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
          ? {
              ...p,
              workExperience: p.workExperience.filter(e => e.id !== expId)
            }
          : p
      )
    }))
  ...
  const updatePersonnelWorkExperience = (personnelId, expId, field, value) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
  ...
  const addPersonnelTraining = (personnelId) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
  ...
  const removePersonnelTraining = (personnelId, trainingId) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
          ? {
              ...p,
              trainings: p.trainings.filter(t => t.id !== trainingId)
            }
          : p
      )
    }))
  ...
  const updatePersonnelTraining = (personnelId, trainingId, field, value) => {
    setFormData(prev => ({
      ...prev,
      personnel: prev.personnel.map(p =>
        p.id === personnelId
  ...
  return (
    <div className="space-y-6">
      ...
      <ValidationAssistant
        ...
        context={{ page: 'organization_details', step: currentStep }}
        realTime={true}
      />
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-2">
                        Upload a document to provide details of Lab Manpower Hierarchy e.g. Organization Structure Diagram on Lab Letter Head.
                        Only PDF file of up to 2 MB size are allowed.
                      </p>
                      <div className="flex items-center gap-4">
                        <div className="flex-1">
              ...
              <div className="space-y-8">
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    Enter the details of Managerial and Technical Personnel of your laboratory.
                  </p>
                </div>
                    ...
                    <div className="space-y-6">
                      {formData.personnel.map((person, index) => (
                        <PersonnelCard
                          ...
                          index={index}
                          formData={formData}
                          onRemove={() => removePersonnel(person.id)}
                          onUpdate={(field, value) => updatePersonnel(person.id, field, value)}
                          onAddQualification={() => addPersonnelQualification(person.id)}
                          onRemoveQualification={(qualId) => removePersonnelQualification(person.id, qualId)}
                          onUpdateQualification={(qualId, field, value) => updatePersonnelQualification(person.id, qualId, field, value)}
                          onAddWorkExperience={() => addPersonnelWorkExperience(person.id)}
                          onRemoveWorkExperience={(expId) => removePersonnelWorkExperience(person.id, expId)}
                          onUpdateWorkExperience={(expId, field, value) => updatePersonnelWorkExperience(person.id, expId, field, value)}
                          onAddTraining={() => addPersonnelTraining(person.id)}
                          onRemoveTraining={(trainingId) => removePersonnelTraining(person.id, trainingId)}
                          onUpdateTraining={(trainingId, field, value) => updatePersonnelTraining(person.id, trainingId, field, value)}
                        />
                      ))}
                    </div>
