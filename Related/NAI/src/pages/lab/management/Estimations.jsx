...
import { LabRecommendationEngine } from '../../../components/aiFeatures'
...
function Estimations() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AI Lab Recommendation Engine */}
      <LabRecommendationEngine
        onProceedWithLab={(result) => {
          toast.success(`Connected with ${result.lab.name}`)
          console.log('Lab connection:', result)
        }}
      />
